public class Data {
    private static final String VALID_CHARACTERS = "QWERTYUIOPASDFGHJKLZXCVBNMqwertyuiopasdfghjklzxcvbnm0123456789_";
    private Data(){}

    public static boolean validate(String login, String password, String confirmPassword) throws RuntimeException {
        try{
